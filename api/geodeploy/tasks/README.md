...
`_clear_restored_running_rows` after the database step, since it restores directly and so
inherits every consequence the restore task has. Any repair added there must be added here.)
